  ...
  switch (status) {
    ...
    case 13:
      return {
        ...
        name: "Cancelada",
        msg_spanish:
          "Cancelado por quiken pero con problemas en la paqueteria ext",
        msj_english:
          "Cancelado por quiken pero con problemas en la paqueteria ext",
      };
    case 14:
    ...
    case 18:
      return {
        ...
        msg_spanish:
          "Envio entregado, se deja en su domicilio para que el cliente",
        msj_english:
          "Shipping delivered, it is left at your home for the customer",
      };
    ...
    case 20:
      return {
        ...
        msj_english:
          "Shipment located in the vicinity for delivery or is returnin",
      };
